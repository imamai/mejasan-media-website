...
import type { WeddingFormOptionsContent } from '@/lib/page-content-schema';
...
export default function WeddingFormClient({ content }: { content: WeddingFormOptionsContent }) {
  const {
    themeOptions: THEME_OPTIONS, photoStyleOptions: PHOTO_STYLE_OPTIONS, videoStyleOptions: VIDEO_STYLE_OPTIONS,
    docuOptions: DOCU_OPTIONS, paOptions: PA_OPTIONS, deliveryOptions: DELIVERY_OPTIONS,
  } = content;
