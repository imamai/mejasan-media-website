...
import type { BookingContent } from '@/lib/page-content-schema';
...
export default function BookingClient({ content }: { content: BookingContent }) {
  const { services: SERVICES, budgets: BUDGETS, hearOptions: HEAR } = content;
